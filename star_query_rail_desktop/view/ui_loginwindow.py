...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/resource/login_picture.jpeg"))
        ...
        self.label_2.setPixmap(QtGui.QPixmap(":/resource/login_picture.jpeg"))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_3.setText(_translate("Form", "没有账号？立即注册"))
